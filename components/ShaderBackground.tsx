...
export default function ShaderBackground({ className }: ShaderBackgroundProps) {
  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      const vec4 lineColor = vec4(0.043, 0.121, 0.231, 1.0); // navy primary
      ...
      void main() {
        ...
        vec4 lines = vec4(0.0);
        vec4 bgColor1 = vec4(0.96, 0.94, 0.91, 1.0);
        vec4 bgColor2 = vec4(0.9, 0.88, 0.83, 1.0);
  ...
  return <canvas ref={canvasRef} className={cn('shader-background-canvas', className)} />;
}
